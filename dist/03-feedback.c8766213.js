...
})({"lsGWg":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "0b1f1c8bc8766213";
...
function onFormData(el) {
    ...
    if (data) return localStorage.setItem(el, data);
}
function dataFromLocalStorage(el) {
    const data = localStorage.getItem(el);
    if (data === null) return el = undefined;
...
function onSubmitForm(e) {
    ...
    if (emailEl === "" || messageEl === "") alert("\u0412\u0441\u0456 \u043F\u043E\u043B\u044F \u043F\u043E\u0432\u0438\u043D\u043D\u0456 \u0431\u0443\u0442\u0438 \u0437\u0430\u043F\u043E\u0432\u043D\u0435\u043D\u0456");
    else if (emailEl !== "" || messageEl !== "") console.log(formData);
    localStorage.removeItem("feedback-form-state");
    form.reset();
}
function inputValue(e) {
    const { elements: { email: email1 , message: message1  } ,  } = e.currentTarget;
    if (email1.value || message1.value) {
        formData = {
            email: email1.value,
            message: message1.value
        };
        (0, _lodashThrottleDefault.default)(onFormData, 500)("feedback-form-state", formData);
    }
}

},{"lodash.throttle":"dfz2R","@parcel/transformer-js/src/esmodule-helpers.js":"3PGlf"}],"dfz2R":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"3PGlf":[function(require,module,exports) {
...
},{}]},["lsGWg","2KVv5"], "2KVv5", "parcelRequire94c2")

//# sourceMappingURL=03-feedback.c8766213.js.map
